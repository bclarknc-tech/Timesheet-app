...
Monitors Main PC Network Share IP (\\192.168.86.62\Clipper) for raw source video files,
...
# Main PC Network Share IP (OfficePC: 192.168.86.62)
VAULT_BASE = r"\\192.168.86.62\Clipper"
