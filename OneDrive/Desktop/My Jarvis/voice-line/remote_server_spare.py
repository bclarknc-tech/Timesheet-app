...
# On spare PC: jarvis-remote account runs this service, but the vault is
# in Brian's (bclar) OneDrive-synced profile. Use the Jarvis 2.0 path.
IDENTITY_CWD = r"C:\Users\bclar\OneDrive\Desktop\Jarvis 2.0"
...
async def ws_endpoint(websocket: WebSocket) -> None:
    ...
    b = brain.Brain(cwd=IDENTITY_CWD, mouth=None)
